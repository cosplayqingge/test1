...
var page = {
	keywords:[
		...
		{item:[{name:'电脑'},{name:'运营商'}]},
		{item:[{name:'吃饭'},{name:'电视'}]},
		{item:[{name:'睡觉'},{name:'运营商'}]},
		{item:[{name:'情歌'},{name:'无敌'}]},
		{item:[{name:'众生'},{name:'平等'}]},
		{item:[{name:'钢铁侠'},{name:'寒月'}]},	
		{item:[{name:'清欢渡'},{name:'忆南挽'}]},
		{item:[{name:'顾北'},{name:'情歌寒'}]},								
	],
	swiper:[
